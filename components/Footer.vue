<template>
    <div id="FooterMain" class="w-full bg-[#3+E8E8E8] mt-10 mb-2">
        <div class="max-w-[1200px] mx-auto px-4">
            ...
            <div class="md:flex gap-4 justify-between w-full">
                <div class="md:w-[50%] pt-4">
                    ...
                    <div class="text-[#999999] text-sm">Help Center, Disputes & Reports, Buyer Protection, Report IPR Infregment , Regulated Information</div>
                </div>
                <div class="md:w-[50%] pt-4">
