<template>
    <div id="MainLayout" class="w-full fixed z-50">
        <div id="TopMenu" class="w-full bg-[#FAFAFA] border-b md:block hidden" >
            <ul class="flex items-center justify-end text-s text-[#333333] font-light px-2 h-10 bg-[#FAFAFA] max-w-[1200px]"> 
                    ...
                    >
                        ...
                        <ul class="bg-white">
                            <li 
                                ...
                                class="text-[13px] px-4 py-2 w-full hover:bg-gray-200"
                            >
                                My Order
                            </li>
                            <li 
        ...
        >
            <div class="flex lg:justify-start justify-between gap-10 max-w-[1150px] w-full px-3 py-5 mx-auto">
                    ...
                    <div class="relative">
                        <div class="flex items-center border-2 border-[#FF4646] rounded-md w-full">
                            ...
                            <button class="flex items-center h-[100%] p-1.5 px-2 bg-[#FF4646]">
                                <Icon name="ph:magnifying-glass" size="25" color="#ffffff" />
                            </button>
                        </div>
                ...
                <button 
                    @click="store.isMenuOverlay = true"
